-- Création des tables pour la base de données de thies

-- Fragmentation horizontale des clients (uniquement les clients de thies)
CREATE TABLE IF NOT EXISTS client (
                                      id SERIAL PRIMARY KEY,
                                      nom VARCHAR(100) NOT NULL,
                                      ville VARCHAR(50) NOT NULL,
                                      email VARCHAR(100) UNIQUE NOT NULL,
                                      CONSTRAINT check_ville CHECK (ville = 'thies')
);
...
CREATE TABLE IF NOT EXISTS commande (
                                        ...
                                        ville VARCHAR(50) NOT NULL default 'thies'
);
...
-- Table pour suivre la répartition du stock entre les villes
